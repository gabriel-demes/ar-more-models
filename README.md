...
1. Make Plant-Category relationship a many-to-many.
    ...
    - **finished code**: <https://github.com/sylwiavargas/ar-more-models/tree/first-and-second>
...
3. Introduce a `Watering` model -- since it's a joiner, it will hold the `id`s of the other models
    ...
    - **finished code**: <https://github.com/sylwiavargas/ar-more-models/tree/third-deliverable>
